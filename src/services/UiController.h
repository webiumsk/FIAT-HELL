...
public:
  UiController(lv_obj_t *&logo, lv_obj_t *&portal, lv_obj_t *&api,
      ...
      : screen_logo(logo), screen_portal(portal), screen_api(api),
        ...
        screen_qr(qr), screen_currency(nullptr) {}

  // WT32 uses a currency-selection screen; S3 does not (7-arg ctor above).
  UiController(lv_obj_t *&logo, lv_obj_t *&portal, lv_obj_t *&api,
               lv_obj_t *&thx, lv_obj_t *&main, lv_obj_t *&insert,
...
private:
  ...
  lv_obj_t *&screen_qr;
  lv_obj_t **screen_currency; // optional (nullptr on boards without it)
};
